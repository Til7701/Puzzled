...
pub struct GridConfig {
    pub grid_cells: Coord,
    pub min_grid_cells: Coord,
...
impl Default for GridConfig {
    fn default() -> Self {
        GridConfig {
            grid_cells: Coord::Regular(RegularCoord::new(1, 1)),
            min_grid_cells: Coord::Regular(RegularCoord::new(1, 1)),
            cell_size_pixel: 1,
        }
    }
}
...
impl PlacementModel {
    pub fn initial_grid_config(puzzle_config: &PuzzleConfig) -> GridConfig {
        ...
        // GridConfig {
        //     grid_cells: Coord::Regular(RegularCoord::new(required_h_cells, required_v_cells)),
        //     min_grid_cells: Coord::Regular(RegularCoord::new(required_h_cells, required_v_cells)),
        //     cell_size_pixel: 1,
        // }
        todo!()
    }
