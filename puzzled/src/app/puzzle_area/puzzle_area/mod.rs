use crate::app::puzzle_area::puzzle_area::board::BoardPresenter;
use crate::app::puzzle_area::puzzle_area::data::{GridConfig, PuzzleAreaData};
use crate::app::puzzle_area::puzzle_area::puzzle_state::{
    Cell, PuzzleState, TileCellPlacement, UnusedTile,
};
use crate::app::puzzle_area::puzzle_area::tile::TilePresenter;
use crate::app::window::main::{MIN_WINDOW_HEIGHT, MIN_WINDOW_WIDTH};
